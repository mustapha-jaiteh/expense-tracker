 ...
 const Authlayout = ({children}) => {
   return (
     <div className='flex'>
      ...
      <h2 className='text-lg font-medium text-black'>Espense Tracker</h2>
      {children}
        </div>
        ...
        <div className='hidden md:block w-[40vw] h-screen bg-violet-50 bg-auth-bg-img bg-cover bg-no-repeat bg-center overflow-hidden p-8 relative'>
            ...
            <img
             src={dashboard} alt="Admin Dashboard"
 ...
 const StatsInfCard = ({icon, label, value, color}) => {
    ...
    return(
        <div className='flex gap-6 bg-white p-4 rounded-xl shadow-md shadow-purple-400/10 z-50 '>
